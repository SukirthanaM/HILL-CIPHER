...
int main()  
{  
    char msg[] = "SUKIRTHANA", enc[100], dec[100];  
...
```
## OUTPUT
<img width="422" height="179" alt="image" src="https://github.com/user-attachments/assets/f9cfabb6-c375-4be9-b838-b3e6d966fb00" />
